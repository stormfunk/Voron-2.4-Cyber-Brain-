# Pen mount — hardware, printing and assembly

The physical half of the plotter. For the Grasshopper pipeline that drives it,
...
![assembled pen-plotter mount](pen_mount/images/assembled-axo.png)

There's a dimensioned assembly drawing in
[`Pen Mount Ortho V3.pdf`](pen_mount/Pen%20Mount%20Ortho%20V3.pdf), one A3 sheet
...
![exploded axonometric view](pen_mount/images/exploded-axo-front.png)

<p align="center">
  <img src="pen_mount/images/exploded-axo-reverse.png" alt="reverse exploded axonometric view" width="49%">
  <img src="pen_mount/images/exploded-side.png" alt="exploded side view" width="49%">
</p>
...
![collet and lock-nut detail](pen_mount/images/collet-detail.png)
...
| 1 | Rail mount | [`01_Linear Rail Mount.stl`](pen_mount/01_Linear%20Rail%20Mount.stl) | Fixed rail support |
| 1 | Moving carriage body | [`02_Linear Rail Carriage.stl`](pen_mount/02_Linear%20Rail%20Carriage.stl) | Spring-loaded carrier body |
| 1 | Collet holder | [`03_Collet Holder.stl`](pen_mount/03_Collet%20Holder.stl) | Threaded housing for the collet system |
| 1 | Collet lock nut | [`04_Collet Lock Nut.stl`](pen_mount/04_Collet%20Lock%20Nut.stl) | Closes and locks the collet |
| 1 | Default collet | [`Collet Default.stl`](pen_mount/Collet%20Default.stl) | **Start here. Fits most pens** |
| Optional | Sized collet | [5 mm](pen_mount/Collet%205mm.stl), [7 mm](pen_mount/Collet%207mm.stl), [9 mm](pen_mount/Collet%209mm.stl), [11 mm](pen_mount/Collet%2011mm.stl), [13 mm](pen_mount/Collet%2013mm.stl), or [15 mm](pen_mount/Collet%2015mm.stl) | For a known barrel diameter. Print only the size you need |
...
[pen tool table](../README.md#pen-tool-table) section of the main README.
